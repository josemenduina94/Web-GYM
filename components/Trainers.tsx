    ...
    <section id="equipo" className="py-24 bg-zinc-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">Expertos con años de experiencia y una sonrisa para motivarte en cada repetición.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {TRAINERS.map(trainer => (
            <div key={trainer.id} className="group relative overflow-hidden rounded-3xl bg-zinc-800 border border-white/5 shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <div className="flex space-x-4 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                  <a href="#" className="hover:text-red-500 text-lg"><i className="fab fa-instagram"></i></a>
                  <a href="#" className="hover:text-red-500 text-lg"><i className="fab fa-facebook"></i></a>
                </div>
              </div>
            </div>
          ))}
